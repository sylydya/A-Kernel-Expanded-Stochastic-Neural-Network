...
parser.add_argument('--data_name', default = 'measurement_error', type = str, help='specify the name of the data')
...
parser.add_argument('--lasso', default=0.0001, type=float, help='lambda parameter for LASSO')
